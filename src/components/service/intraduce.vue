        ...
        <el-row :gutter="20" class="intraduce-detail">
                ...
                <div class="intraduce-two-cards">
                    <div class="intraduce-card el-row">
                        <div>
                            ...
                            <div class="intraduce-card-content">无码化应用搭建能力，弹指间即完成数据从无到有的收集和使用，业务信息化就是如此简单</div>
                    ...
                    <div class="intraduce-card el-row intraduce-card-bottom">
                        <div>
                            ...
                            <span class="intraduce-card-span"></span>
                            <div class="intraduce-card-content">通过拖拽方式就能轻松的搭建多维度海量数据的统计分析、数据可视化</div>
                            <el-button type="primary" round size="small">了解更多</el-button>
                        </div>
            ...
            <el-col :span="4">
                <div class="intraduce-center" ref="intraduceCenter">
                    <img src="../../../static/images/inside-arrow.png" class="intraduce-cycle intraduce-cycle-inside" ref="insideCycle"/>
                    <img src="../../../static/images/outsite-arrow.png" class="intraduce-cycle intraduce-cycle-outside" ref="outsideCycle"/>
                    <img src="../../../static/images/grow-up.png" class="intraduce-cycle intraduce-cycle-arrow"/>
                </div>
            </el-col>
            <el-col :span="10">
                <div class="intraduce-two-cards">
                    <div class="intraduce-card el-row">
                        ...
                        <div class="intraduce-card-right">
                            <div class="intraduce-card-title intraduce-card-align-right">数据连接</div>
                            <div class="intraduce-card-align-right"><span class="intraduce-card-span"></span></div>
                            <div class="intraduce-card-content intraduce-card-align-right">轻松融合不同类型、不同存储终端的海量数据，继而实现数据毫秒级传输速度，所接即所得，快得不可思议</div>
                            <div class="intraduce-card-align-right"><el-button type="primary" round size="small">了解更多</el-button></div>
                        </div>
                    </div>
                    <div class="intraduce-card el-row intraduce-card-bottom">
                        <div><img src="../../../static/images/card-right-bottom.png"/></div>
                        <div class="intraduce-card-right">
                            <div class="intraduce-card-title intraduce-card-align-right">数据治理</div>
                            <div class="intraduce-card-align-right"><span class="intraduce-card-span"></span></div>
                            <div class="intraduce-card-content intraduce-card-align-right">专业智能的数据处理、校验、优化，让冗杂的海量数据瞬间变得条理清晰井然有序，管理数据轻松简单</div>
                            <div class="intraduce-card-align-right"><el-button type="primary" round size="small">了解更多</el-button></div>
                        </div>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        startCycle () {
            ...
            this.$refs.insideCycle.style.setProperty('transform', 'rotate(' + this.insiteRotate + 'deg)')
            this.$refs.insideCycle.style.setProperty('transform', 'rotate(' + this.insiteRotate + 'deg)')
            this.$refs.outsideCycle.style.setProperty('transform', 'rotate(' + this.outsiteRotate + 'deg)')
            this.$refs.outsideCycle.style.setProperty('transform', 'rotate(' + this.outsiteRotate + 'deg)')
            setTimeout(this.startCycle, 100)
        }
    },
    created () {
        setTimeout(this.startCycle, 100)
